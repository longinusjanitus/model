...
<html>
<head>
<link rel="shortcut icon" href="model.png" type="image/x-icon">
...
<body>
<div class='window'>
<h1><a href=<?php echo 'favicon.png'; ?>>
<img class='hover' style="width:92px;height:92px;" src=<?php echo 'favicon.png'; ?>></a><?php echo ' '.$name; ?></h1>
